...
## Installation
To download the CPPCS, download `cppcs.exe` from the root folder of this repository. This executable contains the full command line interface and is ready for use immediately upon download.
